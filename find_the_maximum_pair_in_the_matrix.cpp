/*
Given an n x n matrix mat[n][n] of integers, find the maximum value
of mat(c, d) – mat(a, b) over all choices of indexes such that both
 c > a and d > b.
Example: 
...
The program should do only ONE traversal of the matrix. i.e. expected
...
and d > b and keeps on updating maximum value found so far. We finally return 
the maximum value.
...
// find the maximum pair in the matrix
